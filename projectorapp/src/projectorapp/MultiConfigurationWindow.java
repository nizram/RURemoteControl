...
public class MultiConfigurationWindow extends javax.swing.JFrame
{
    /**
     * Creates new form NewJFrame
     */
    
    public MultiConfigurationWindow() {
        initComponents();
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MultiConfigurationWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MultiConfigurationWindow().setVisible(true);
            }
        });
    }
